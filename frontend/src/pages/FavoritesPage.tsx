      ...
      <div className={styles.container}>
        ...
        <header className={styles.headerGroup}>
          ...
          <p className={styles.subtitle}>
            Your curated collection of top picks and saved items
          </p>
        </header>
            ...
            {items.map((item) => {
              ...
              return (
                <article key={item.id} className={styles.productCard}>
                  {/* Remove Floating Badge Button */}
                  <button
                    type="button"
                    className={styles.removeBadgeBtn}
                    onClick={() => removeMutation.mutate(item.productId)}
                    disabled={isRemoving}
                    aria-label={`Remove ${item.product?.name ?? "item"} from favorites`}
